                    ...
                    <tr>
                        <td valign="top" mc:edit="headerBrand" id="templateContainerHeader">
                            ...
                            <p style="text-align:center;margin:0;padding:0;">
                                <img src="{{$logoUrl}}" style="max-width:600px;display:inline-block;" />
                            </p>
                            ...
                            <tr>
                                <td width="50%">
                                    @if(!empty($approveLink))
                                        <p style="text-align: center; width:100%"><a class="blue-btn" href="{{$approveLink}}"><strong>Approve</strong></a></p>
                                    @endif
                                </td>
                                <td width="50%">
                                    @if(!empty($denyLink))
                                        <p style="text-align: center; width:100%"><a class="red-btn" href="{{$denyLink}}"><strong>Deny</strong></a></p>
                                    @endif
                                </td>
                            </tr>
                        </table>
...
<style type="text/css">
  ...
  */
    ...
    a.red-btn {
        ...
        display: inline-block;
        color: #FFFFFF;
        border-top:10px solid #EA131E;
        border-bottom:10px solid #EA131E;
        border-left:20px solid #EA131E;
        border-right:20px solid #EA131E;
        text-decoration: none;
        font-size: 14px;
        margin-top: 1.0em;
        border-radius: 3px 3px 3px 3px;
