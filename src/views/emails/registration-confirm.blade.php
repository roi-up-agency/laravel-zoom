                ...
                @if(!empty($logoUrl))
                    <tr>
                        <td id="templateContainerHeader" valign="top" mc:edit="welcomeEdit-01">
                            <p style="text-align:center;margin:0;padding:0;"><img src="{{$logoUrl}}" style="display:inline-block;"></p>
                        </td>
                    </tr>
                @endif
                <tr>
                        ...
                        "brdBottomPadd-two" id="templateContainer" width="100%">
                            <tr>
                                <td class="bodyContent" valign="top" mc:edit="welcomeEdit-02">
                                    ...
                                    <h1><strong>Thank you for registering for "{{$topic}}"!</strong></h1>

                                    <h3>Please submit any questions to: <a href="mailto:{{$ownerEmail}}">{{$ownerEmail}}</a></h3>
                                </td>
                            </tr>
                        </table>
                    </td>
                            ...
                            <tr valign="top">
                                <td align="center" class="bodyContentTicks">
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        ...
                                        <tr valign="top">
                                            <td valign="top" mc:edit="welcomeEditImgFirst" style="width:10%;color:#505050;font-family:Helvetica;font-size:14px;padding-bottom:1.143em;">
                                                <p style=
                                                   "text-align:center;margin:15px 0 15px 0;padding:0;">
                                                    <img height="" src="http://c0185784a2b233b0db9b-d0e5e4adc266f8aacd2ff78abb166d77.r51.cf2.rackcdn.com/templates/circle.jpg" style="display:block;" width="75"></p>
                                            </td>
                                        ...
                                        <tr valign="top">
                                            <td valign="top" mc:edit="welcomeEditImgFirst" style="width:10%;color:#505050;font-family:Helvetica;font-size:14px;padding-bottom:1.143em;">
                                                <p style="text-align:center;margin:15px 0 15px 0;padding:0;">
                                                    <img height="" src="http://c0185784a2b233b0db9b-d0e5e4adc266f8aacd2ff78abb166d77.r51.cf2.rackcdn.com/templates/circle.jpg" style="display:block;" width="75"></p>
                                            </td>
                                            ...
                                            <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:80%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                                                <h3><strong>Your access</strong></h3>
                                                <p>Join from PC, Mac, Linux, iOS or Android: <a href="{{$joinUrl}}">Click Here to Join</a></p>
                                                @if(!empty($password))
                                                    <p>Password: {{$password}}</p>
                                                    <p><strong>Note:</strong> This link should not be shared with others; it is unique to you.</p>
                                                @endif
                                            </td>
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:80%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                                                <h3><strong>Add to your Calendar</strong></h3>
                                                <p><a href="{{$calendarLinks['icalendar']}}">Add to Calendar</a></p>
                                                <p><a href="{{$calendarLinks['google']}}">Add to Google Calendar</a></p>
                                                <p><a href="{{$calendarLinks['yahoo']}}">Add to Yahoo Calendar</a></p>
                                            </td>
